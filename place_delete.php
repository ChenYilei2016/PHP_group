 ...
 * Time: 18:22
 */
	$deleteId = $_GET['place_id'];
	$sql = 'delete from place where place_id ='.$deleteId;
	$result = mysqli_query($conn,$sql);
	$href = 'place_list.php';
$sql_ = "insert into log (log_user,log_info,log_createtime) values ('".$_SESSION["username"]."','"."用户删除一个地区:"."',".time().") ";//插入日志
