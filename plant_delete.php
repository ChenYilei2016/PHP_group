 ...
 * Time: 18:22
 */
	$deleteId = $_GET['plant_id'];
	$sql = 'delete from plant where plant_id ='.$deleteId;
	...
	$href = 'plant_list.php';
$sql_ = "insert into log (log_user,log_info,log_createtime) values ('".$_SESSION["username"]."','"."用户删除一条生物记录:"."',".time().") ";//插入日志
