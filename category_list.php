            ...
            <div class="panel  heading-border">
              ...
              <div class="panel-body pn">
                <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                  <thead>
                    <tr class="">
                      <th class="hidden-xs text-center">分类编号</th>
                      <th class="hidden-xs text-center">分类名字</th>
                  ...
                  <?php
                      ...
                      ?>
                        <tr class="message-unread">
                          ...
                          <td class="text-center fw600"><?php echo $row['category_name']?></td>
                          <td class="text-center">
                            <a href="category_update.php?category_id=<?php echo $row['category_id']?>">修改</a>|
