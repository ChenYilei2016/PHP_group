...
//var_dump($_POST['name']);
$sql = 'select * from place where place_id='.$_GET['place_id'];
        ...
        <div class="tray tray-center">
            ...
            <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
              ...
              <div class="panel heading-border">
                ...
                <form method="post" action="place_update_in.php" id="admin-form">
                  ...
                  <div class="panel-body bg-light">
                    ...
                    <div class="section">
                      <label for="useremail" class="field prepend-icon">
                        ...
                        <input type="text" name="place_name" id="cause" class="gui-input" placeholder="地区名称" value="<?php echo $row['place_name'] ?>">
